...
public class Cell extends JComponent {
	...
	/**
	 * @return The {@link Board} that this {@link Cell} belongs to
	 */
	...
	/**
	 * @return Row this {@link Cell} is on
	 */
	public int getRow() {
		return this.row;
	}
	...
	/**
	 * @return Column this {@link Cell} is on
	 */
	...
	/**
	 * @return The {@link Agent} that is occupying this {@link Cell} at this time.
	 *         Will be null if there is currently no {@link Agent} on this
	 *         {@link Cell}
	 */
	public Agent<? extends Agent<?>> getOccupying() {
		return this.occupying;
	}

	/**
	 * @return Label for displaying the occupying {@link Agent} on this {@link Cell}
	 *         on the screen
	 */
